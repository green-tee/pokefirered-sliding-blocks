...
$(SLIDINGBLOCKSGFXDIR)/puzzle_voltorb.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(SLIDINGBLOCKSGFXDIR)/puzzle_electrode.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(SLIDINGBLOCKSGFXDIR)/puzzle_numbers_1.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
...
$(SLIDINGBLOCKSGFXDIR)/puzzle_numbers_reds_round.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(SLIDINGBLOCKSGFXDIR)/puzzle_numbers_69.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(SLIDINGBLOCKSGFXDIR)/puzzle_birds.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
...
$(SLIDINGBLOCKSGFXDIR)/hand.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
