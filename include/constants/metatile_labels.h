...
#define METATILE_Lab_PuzzlePalace_Corner_FacingLeftShaded     0x292
#define METATILE_Lab_PuzzlePalace_Corner_FacingRight          0x294
#define METATILE_Lab_PuzzlePalace_Corner_FacingRightShaded    0x295
...
#define METATILE_Lab_PuzzlePalace_Ledge                       0x2B8
#define METATILE_Lab_PuzzlePalace_LedgeLeft                   0x2B6
#define METATILE_Lab_PuzzlePalace_LedgeRight                  0x2B7
#define METATILE_Lab_PuzzlePalace_SmallTree_Bottom            0x2AC
#define METATILE_Lab_PuzzlePalace_SmallTree_Top               0x2A4
#define METATILE_Lab_PuzzlePalace_SmallTree_TopShaded         0x2B9
#define METATILE_Lab_PuzzlePalace_SmallTree_Top_Wall_Bottom   0x2A7
#define METATILE_Lab_PuzzlePalace_TallGrass                   0x2AD
#define METATILE_Lab_PuzzlePalace_Tile                        0x280
#define METATILE_Lab_PuzzlePalace_TileArrowUp                 0x2C2
#define METATILE_Lab_PuzzlePalace_TileCornerSouthEast         0x289
#define METATILE_Lab_PuzzlePalace_TileCornerSouthEastShaded   0x29F
#define METATILE_Lab_PuzzlePalace_TileCornerSouthWest         0x288
#define METATILE_Lab_PuzzlePalace_TileCornerSouthWestShaded   0x293
#define METATILE_Lab_PuzzlePalace_TileShaded                  0x281
#define METATILE_Lab_PuzzlePalace_TreeMiddleLeft              0x2A8
#define METATILE_Lab_PuzzlePalace_TreeMiddleRight             0x2A9
#define METATILE_Lab_PuzzlePalace_Upstairs                    0x286
#define METATILE_Lab_PuzzlePalace_Wall_Bottom                 0x28B
#define METATILE_Lab_PuzzlePalace_Wall_BottomCornerSouthEast  0x28D
#define METATILE_Lab_PuzzlePalace_Wall_BottomCornerSouthWest  0x28A
#define METATILE_Lab_PuzzlePalace_Wall_BottomPuzzle           0x28C
#define METATILE_Lab_PuzzlePalace_Wall_Top                    0x283
#define METATILE_Lab_PuzzlePalace_Wall_TopCornerNorthEast     0x285
#define METATILE_Lab_PuzzlePalace_Wall_TopCornerNorthWest     0x282
