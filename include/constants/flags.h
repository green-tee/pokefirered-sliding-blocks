...
#define FLAG_HIDE_THE_FULL_PICTURE_MASTER_BALL             0x02C
#define FLAG_HIDE_OBSTACLE_COURSE_SITRUS_BERRY             0x02D
#define FLAG_HIDE_THE_EYE_OF_TRUTH_SITRUS_BERRY            0x02E
#define FLAG_HIDE_MASTER_OF_ALL_TRADES_SITRUS_BERRY        0x02F
#define FLAG_HIDE_MASTER_OF_ALL_TRADES_MASTER_BALL         0x030
...
#define FLAG_SOLVED_ALAKAZAM                             0x23D
#define FLAG_SOLVED_SNORLAX                              0x23E
#define FLAG_SOLVED_DUGTRIO                              0x23F
#define FLAG_SOLVED_RAICHU                               0x240
#define FLAG_SOLVED_BLASTOISE                            0x241
#define FLAG_SOLVED_VENUSAUR                             0x242
#define FLAG_SOLVED_PIDGEOT                              0x243
#define FLAG_SOLVED_HITMONCHAN                           0x244
#define FLAG_SOLVED_GENGAR                               0x245
#define FLAG_SOLVED_CHARIZARD                            0x246
...
#define FLAG_HIDDEN_ITEM_BRAINING_ISLAND_MASTER_BALL                       (FLAG_HIDDEN_ITEMS_START +   0)
#define FLAG_HIDDEN_ITEM_THE_FULL_PICTURE_SITRUS_BERRY                     (FLAG_HIDDEN_ITEMS_START +   1)
#define FLAG_HIDDEN_ITEM_BRAINING_ISLAND_SITRUS_BERRY                      (FLAG_HIDDEN_ITEMS_START +   2)
#define FLAG_HIDDEN_ITEM_FIRST_STEPS_SITRUS_BERRY                          (FLAG_HIDDEN_ITEMS_START +   3)
#define FLAG_HIDDEN_ITEM_FIRST_STEP_MASTER_BALL                            (FLAG_HIDDEN_ITEMS_START +   4)
#define FLAG_HIDDEN_ITEM_VOLTORB_FLIP_SITRUS_BERRY                         (FLAG_HIDDEN_ITEMS_START +   5)
#define FLAG_HIDDEN_ITEM_VOLTORB_FLIP_MASTER_BALL                          (FLAG_HIDDEN_ITEMS_START +   6)
#define FLAG_HIDDEN_ITEM_OBSTACLE_COURSE_MASTER_BALL                       (FLAG_HIDDEN_ITEMS_START +   7)
#define FLAG_HIDDEN_ITEM_THE_EYE_OF_TRUTH_MASTER_BALL                      (FLAG_HIDDEN_ITEMS_START +   8)
#define FLAG_HIDDEN_ITEM_THE_LOST_WOODS_SITRUS_BERRY                       (FLAG_HIDDEN_ITEMS_START +   9)
#define FLAG_HIDDEN_ITEM_THE_LOST_WOODS_MASTER_BALL                        (FLAG_HIDDEN_ITEMS_START +  10)
#define FLAG_HIDDEN_ITEM_THE_FINAL_PIECE_OF_THE_PUZZLE_SITRUS_BERRY        (FLAG_HIDDEN_ITEMS_START +  11)
#define FLAG_HIDDEN_ITEM_THE_FINAL_PIECE_OF_THE_PUZZLE_MASTER_BALL         (FLAG_HIDDEN_ITEMS_START +  12)
